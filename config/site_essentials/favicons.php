...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Auto Generation of Favicons Configuration
    |--------------------------------------------------------------------------
    |
    | Specifies whether favicons are automatically regenerated
    | when the "Site Settings" global is updated or changed.
    |
    | A Tidal Starter Kit specific configuration option.
    |
    */
